...
int Langevin_pre(double E, double M, double temp, double drag, double kpara, double kperp, double delta_lrf, std::vector<double> & pre_result);
int Langevin_post(double E, double M, double temp, double drag, double kpara, double kperp, double delta_lrf, std::vector<double> const& pre_result, std::vector<double> & post_result);
