...
cdef extern from "../src/Langevin.h":
    cdef int Langevin_pre(double E1, double mass, double temp, double drag, double kperp, double kpapa, double delta_lrf, vector[double] & pre_result)
    cdef int Langevin_post(double E1, double mass, double temp, double drag, double kperp, double kpara, double delta_lrf, vector[double] & pre_result, vector[double] & post_result)
